...
cl /nologo /O2 /W3 /MT /EHs- /GS- /I ..\minhook\include ^
  /Foobj64\ /Fdobj64\pump_guard_64bit.pdb ^
  pump_guard.cpp ^
  ..\minhook\src\buffer.c ..\minhook\src\hook.c ^
  ..\minhook\src\trampoline.c ..\minhook\src\hde\hde64.c ^
  /link /DLL /MACHINE:X64 /OUT:pump_guard_64bit.dll /PDB:pump_guard_64bit.pdb ^
  user32.lib d3d9.lib /OPT:REF /OPT:ICF /INCREMENTAL:NO || exit /b 1

echo Built pump_guard_64bit.dll
endlocal
